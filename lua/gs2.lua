...
function on_dialog()
    -- get id from gs2 dialog id location
    local dialog_id = memory.readwordsigned(0x020301C4, "System Bus")
...
-- register the gs2 dialog function
memory.registerexec(0x080D407C, on_dialog)
